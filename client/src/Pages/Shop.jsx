...
const Shop = () => {
  ...
  function SkeletonLoading() {
    return (
      <div
        role="status"
        className="max-w-sm p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700 xl:w-[300px] "
      >
      ...
      <div className="container">
        <aside className="grid grid-cols-12 gap-y-5 lg:gap-8">
          ...
          <div className="col-span-12 lg:col-span-10">
            ...
            <div className="grid  grid-cols-2 lg:grid-cols-3 gap-5">
              {showAllProducts
                ? allProducts.map((item, i) => <Product productinfo={item} />)
            ...
            <div className=" flex justify-center mt-5 ">
              {!loading && !showAllProducts && (
                <Button onClick={handleShowallProduct} variant="outline">
                  Show All
                </Button>
              )}
