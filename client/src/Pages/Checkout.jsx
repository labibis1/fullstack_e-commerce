...
const Checkout = () => {
  return (
    <div className="container ">
      <div className="bg-white dark:bg-gray-400 dark:rounded-xl mt-10 dark:py-20 sm:px-20 ">
        <div className="md:max-w-5xl max-w-xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 max-md:order-1 ">
              ...
              <p className="text-slate-500 dark:text-gray-800 text-sm mt-4">
              ...
              <div className="mt-8 max-w-lg ">
                {/* Address and phone */}
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mt-10">
                    Shiping address
                  </h3>
                  <input
                    type="text"
                    placeholder="Address line 1"
                    className="px-4 py-3.5 bg-gray-100 mt-4 text-slate-900 w-full text-sm border rounded-md focus:border-purple-500 focus:bg-transparent outline-none"
                  />
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    <div>
                      <input
                        type="text"
                        placeholder="City."
                        className="px-4 py-3.5 bg-gray-100 text-slate-900 w-full text-sm border rounded-md focus:border-purple-500 
                        focus:bg-transparent outline-none"
                      />
                    </div>
                    <div>
                      <input
                  ...
                  <input
                    ...
                    className="px-4 py-3.5 bg-gray-100 mt-4 text-slate-900 w-full text-sm border rounded-md focus:border-purple-500 
                    focus:bg-transparent outline-none "
                  />
                </div>
            ...
            <div className="bg-gray-100 p-6 rounded-lg h-100 dark:mt-30">
              <h2 className="text-2xl font-semibold text-slate-900 mt-15">$250.00</h2>
              <ul className="text-slate-500 font-medium mt-8 space-y-4">
                ...
                <li className="flex flex-wrap gap-4 text-[15px] font-semibold text-slate-900 border-t-2 pt-4">
