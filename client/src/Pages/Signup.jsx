...
const Signup = () => {
  return (
    ...
    <form className="max-w-96 w-full text-center border border-gray-300/60 dark:border-gray-700 rounded-2xl px-8 bg-white dark:bg-gray-800">
      <h1 className="text-gray-900 dark:text-white text-3xl mt-10 font-medium">Signup</h1>
      <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">Create an account</p>
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm mt-3 mb-11">
        ...
        <Link className="text-indigo-500 dark:text-indigo-400 hover:underline" to="/login">
          Login
        </Link>
      </p>
    </form>
