  ...
  return (
    <section className="container flex items-center justify-center min-h-screen bg-white dark:bg-gray-900">
      ...
      <form
        ...
        className="max-w-96 w-full text-center border border-gray-300/60 dark:border-gray-700 rounded-2xl px-8 bg-gray-50 dark:bg-gray-800"
      >
        ...
        {/* full name input */}
        <div className="flex items-center mt-10 w-full bg-white dark:bg-gray-800 border border-gray-300/80 dark:border-gray-700 h-12 rounded-full overflow-hidden pl-6 gap-2">
          {/* <svg
            width={13}
            height={17}
            viewBox="0 0 13 17"
        ...
        <div className="flex items-center w-full mt-3  bg-white dark:bg-gray-800 border border-gray-300/80 dark:border-gray-700 h-12 rounded-full overflow-hidden pl-6 gap-2">
          <svg
            width={16}
            height={11}
            viewBox="0 0 16 11"
